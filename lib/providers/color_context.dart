...
class ContextTheme extends InheritedWidget {
  ...
  Color get primaryContainer => themeProvider.currentTheme.colorScheme.primaryContainer;
  Color get onPrimaryContainer => themeProvider.currentTheme.colorScheme.onPrimaryContainer;
  ...
  Color get secondaryContainer => themeProvider.currentTheme.colorScheme.secondaryContainer;
  Color get onSecondaryContainer => themeProvider.currentTheme.colorScheme.onSecondaryContainer;
  ...
  Color get tertiaryContainer => themeProvider.currentTheme.colorScheme.tertiaryContainer;
  Color get onTertiaryContainer => themeProvider.currentTheme.colorScheme.onTertiaryContainer;
  ...
  Color get errorContainer => themeProvider.currentTheme.colorScheme.errorContainer;
  Color get onErrorContainer => themeProvider.currentTheme.colorScheme.onErrorContainer;
  ...
  Color get surfaceVariant => themeProvider.currentTheme.colorScheme.surfaceVariant;
  Color get onSurfaceVariant => themeProvider.currentTheme.colorScheme.onSurfaceVariant;
  ...
  Color get inverseSurface => themeProvider.currentTheme.colorScheme.inverseSurface;
  Color get onInverseSurface => themeProvider.currentTheme.colorScheme.onInverseSurface;
  Color get inversePrimary => themeProvider.currentTheme.colorScheme.inversePrimary;
  Color get surfaceTint => themeProvider.currentTheme.colorScheme.surfaceTint;

  TextStyle get displayLarge => themeProvider.currentTheme.textTheme.displayLarge!;
  TextStyle get displayMedium => themeProvider.currentTheme.textTheme.displayMedium!;
  TextStyle get displaySmall => themeProvider.currentTheme.textTheme.displaySmall!;
  TextStyle get headlineLarge => themeProvider.currentTheme.textTheme.headlineLarge!;
  TextStyle get headlineMedium => themeProvider.currentTheme.textTheme.headlineMedium!;
  TextStyle get headlineSmall => themeProvider.currentTheme.textTheme.headlineSmall!;
  TextStyle get titleLarge => themeProvider.currentTheme.textTheme.titleLarge!;
  TextStyle get titleMedium => themeProvider.currentTheme.textTheme.titleMedium!;
  ...
  TextStyle get labelMedium => themeProvider.currentTheme.textTheme.labelMedium!;
